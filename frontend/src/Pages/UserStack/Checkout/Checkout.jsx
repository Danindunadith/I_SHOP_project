                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-8">
                                            <form className='needs-validation' noValidate onSubmit={handleSubmit}>
                                                ...
                                                {/* card detail */}
                                                <h4 className='bg-primary-subtle p-2 rounded'>Card Details</h4>
                                                <div className="row mb-4">
                                                    <div className="col-6">
                                                        <label htmlFor="cnum" className="form-label">Card Number</label>
                                                        <div className="input-group">
                                                            <input
                                                                type="text"
                                                                maxLength="12"
                                                    ...
                                                    <div className="col-3">
                                                        <label htmlFor="cname" className="form-label">Card Name</label>
                                                        <div className="input-group">
                                                            <input
                                                                type="text"
                                                    ...
                                                    <div className="col-3">
                                                        <label htmlFor="UserCVC" className="form-label">CVC</label>
                                                        <div className="input-group">
                                                            <input
                                                                type="text"
                                                                maxLength="3"
                                                ...
                                                <div className="d-flex justify-content-end mb-2">
                                                    <button type="button" disabled={loading} onClick={() => {
                                                        navigate("/coupons")
                                                    }} className="btn btn-danger mx-2">Add Coupon</button>
